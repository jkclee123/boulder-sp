...
// Transfer private pass function
export const transferPrivatePass = onCall(async (request) => {
    ...
    try {
        return await db.runTransaction(async (transaction) => {
            var _a;
            // Get source private pass document
            const sourcePassRef = db.collection('privatePass').doc(passId);
        ...
        console.error('Error in transferPrivatePass:', error);
